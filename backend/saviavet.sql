...
VALUES 
('Luna', 'Perro', 'Border Collie', '2022-05-15', 'https://images.unsplash.com/photo-1503256207526-0d5d80fa2f47?q=80&w=400', 'Luna es muy activa y le encanta correr tras el disco.', 'En Adopción', 2),
('Simba', 'Gato', 'Común Europeo', '2023-01-10', 'https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?q=80&w=400', 'Un gato tranquilo que busca un sofá cálido y mucho cariño.', 'En Adopción', 2),
('Rocky', 'Perro', 'Bulldog Francés', '2021-11-20', 'https://images.unsplash.com/photo-1583511655857-d19b40a7a54e?q=80&w=400', 'Pequeño pero con una gran personalidad. Se lleva bien con niños.', 'En Adopción', 2),
('Nala', 'Gato', 'Siamés', '2023-06-01', 'https://images.unsplash.com/photo-1513245543132-31f507417b26?q=80&w=400', 'Nala es un poco tímida al principio pero muy leal una vez te conoce.', 'En Adopción', 2),
('Coco', 'Perro', 'Labrador', '2020-03-12', 'https://images.unsplash.com/photo-1552053831-71594a27632d?q=80&w=400', 'El compañero ideal para largas caminatas por la montaña.', 'En Adopción', 2);
